...
module MundiApi
  ...
  class CreatePhonesRequest < BaseModel
    ...
    def self.from_hash(hash)
      ...
      home_phone = CreatePhoneRequest.from_hash(hash['home_phone']) if hash['home_phone']
      mobile_phone = CreatePhoneRequest.from_hash(hash['mobile_phone']) if hash['mobile_phone']
