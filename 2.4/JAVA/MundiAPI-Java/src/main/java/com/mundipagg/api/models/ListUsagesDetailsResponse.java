...
/**
 * This is a model class for ListUsagesDetailsResponse type.
 */
public class ListUsagesDetailsResponse {
    ...
    /**
     * Converts this ListUsagesDetailsResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ListUsagesDetailsResponse [" + "data=" + data + ", paging=" + paging + "]";
    }

    /**
     * Builds a new {@link ListUsagesDetailsResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ListUsagesDetailsResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ListUsagesDetailsResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ListUsagesDetailsResponse} object using the set fields.
         * @return {@link ListUsagesDetailsResponse}
         */
        public ListUsagesDetailsResponse build() {
            return new ListUsagesDetailsResponse(data, paging);
        }
    }
}
