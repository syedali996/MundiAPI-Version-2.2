...
namespace MundiAPI.Standard.Controllers
{
    ...
    internal class SubscriptionsController : BaseController, ISubscriptionsController
    {
        ...
        public Models.GetUsagesDetailsResponse GetUsagesDetails(
                ...
                string mGroup = null)
        {
            Task<Models.GetUsagesDetailsResponse> t = this.GetUsagesDetailsAsync(subscriptionId, cycleId, size, page, itemId, mGroup);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
                ...
                CancellationToken cancellationToken = default)
        {
            ...
            // prepare query string for API call.
            StringBuilder queryBuilder = new StringBuilder(baseUri);
            queryBuilder.Append("/subscriptions/{subscription_id}/usages-details/");
            ...
            return ApiHelper.JsonDeserialize<Models.GetUsagesDetailsResponse>(response.Body);
        }
