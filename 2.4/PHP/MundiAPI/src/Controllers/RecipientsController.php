...
use MundiAPILib\Models\CreateAnticipationRequest;
...
use MundiAPILib\Models\GetAnticipationLimitResponse;
use MundiAPILib\Models\GetAnticipationResponse;
use MundiAPILib\Models\GetBalanceResponse;
use MundiAPILib\Models\GetRecipientResponse;
use MundiAPILib\Models\GetTransferResponse;
use MundiAPILib\Models\GetWithdrawResponse;
use MundiAPILib\Models\ListAnticipationResponse;
use MundiAPILib\Models\ListRecipientResponse;
use MundiAPILib\Models\ListTransferResponse;
use MundiAPILib\Models\ListWithdrawals;
...
class RecipientsController extends BaseController
{
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/recipients/code/{code}')
            ->auth('global')
