 ...
 */
public final class PagarmeCoreApiClient implements PagarmeCoreApiClientInterface {
    ...
    private static String userAgent = "PagarmeCoreApi - Java 5.7.0";
    ...
    private PagarmeCoreApiClient(Environment environment, HttpClient httpClient,
    ...
    /**
     * Converts this PagarmeCoreApiClient into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PagarmeCoreApiClient [" + "environment=" + environment + ", httpClientConfig="
                + httpClientConfig + ", authentications=" + authentications + "]";
    }

    /**
     * Builds a new {@link PagarmeCoreApiClient.Builder} object.
     * Creates the instance with the state of the current client.
     * @return a new {@link PagarmeCoreApiClient.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PagarmeCoreApiClient}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new PagarmeCoreApiClient object using the set fields.
        ...
        public PagarmeCoreApiClient build() {
            ...
            return new PagarmeCoreApiClient(environment, httpClient, httpClientConfig,
