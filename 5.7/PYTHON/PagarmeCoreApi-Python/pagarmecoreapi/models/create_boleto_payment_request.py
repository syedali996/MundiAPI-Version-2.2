...
from pagarmecoreapi.models.create_fine_request import CreateFineRequest
from pagarmecoreapi.models.create_interest_request import CreateInterestRequest
