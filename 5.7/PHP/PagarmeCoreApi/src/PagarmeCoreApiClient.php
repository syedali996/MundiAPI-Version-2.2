...
use PagarmeCoreApiLib\Controllers\InvoicesController;
use PagarmeCoreApiLib\Controllers\OrdersController;
use PagarmeCoreApiLib\Controllers\PlansController;
use PagarmeCoreApiLib\Controllers\RecipientsController;
use PagarmeCoreApiLib\Controllers\SubscriptionsController;
use PagarmeCoreApiLib\Controllers\TokensController;
use PagarmeCoreApiLib\Controllers\TransactionsController;
use PagarmeCoreApiLib\Controllers\TransfersController;
use PagarmeCoreApiLib\Exceptions;
use PagarmeCoreApiLib\Utils\CompatibilityConverter;
use Unirest\Configuration;
use Unirest\HttpClient;

class PagarmeCoreApiClient implements ConfigurationInterface
{
    private $plans;
    ...
    /**
     * @see PagarmeCoreApiClientBuilder::init()
     * @see PagarmeCoreApiClientBuilder::build()
     *
     * @param array $config
     */
    public function __construct(array $config = [])
    {
        ...
        $this->client = ClientBuilder::init(new HttpClient(Configuration::init($this)))
            ...
            ->userAgent('PagarmeCoreApi - PHP 5.7.0')
     ...
     *
     * @return PagarmeCoreApiClientBuilder PagarmeCoreApiClientBuilder instance
     */
    public function toBuilder(): PagarmeCoreApiClientBuilder
    {
        return PagarmeCoreApiClientBuilder::init()
     ...
     *
     * @see PagarmeCoreApiClientBuilder::getConfiguration()
     */
